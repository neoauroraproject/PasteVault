...
import { Trash2, Eye, Lock, Copy, ExternalLink, Paperclip } from "lucide-react"
            ...
            return (
              ...
              >
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    {hasAttachments && (
                      <span className="flex items-center gap-0.5 text-[10px] text-muted-foreground">
                        ...
                        {paste.attachments!.length} file
                        {paste.attachments!.length > 1 ? "s" : ""}
                      </span>
                    )}
                  </div>
                </TableCell>
                ...
                <TableCell className="hidden md:table-cell text-sm text-muted-foreground">
                  {formatDistanceToNow(new Date(paste.created_at), {
                    addSuffix: true,
                  })}
                </TableCell>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will permanently delete this paste and its
                            public link.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>

      ...
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-transparent">
            ...
            <TableHead className="text-muted-foreground hidden md:table-cell">Uploaded</TableHead>
            ...
            <TableRow key={file.id}>
              ...
              <TableCell className="text-right">
                <div className="flex items-center justify-end gap-1">
                  <Button variant="ghost" size="sm" onClick={() => copyLink(file.id)} className="h-8 w-8 p-0 text-muted-foreground hover:text-foreground">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>This will permanently delete &ldquo;{file.original_name}&rdquo; from storage.</AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
